...
export const SYNC_JOB_TYPES = {
	...
	SECTION_BATCH_REPORT: "section_batch_report",
	GITHUB_ACCESS_SYNC: "github_access_sync",
	ENTRA_TEAM_MEMBER_SYNC: "entra_team_member_sync",
} as const
...
export const ALL_SYNC_JOB_TYPES: SyncJobType[] = [
	...
	SYNC_JOB_TYPES.ENTRA_TEAM_MEMBER_SYNC,
	SYNC_JOB_TYPES.GITHUB_ACCESS_SYNC,
	SYNC_JOB_TYPES.SECTION_BATCH_REPORT,
