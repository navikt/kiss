...
export function ApproveReplaceModal({
	modalRef,
	routineName,
	hasSource,
}: {
	...
	// Synk state når hasSource endres (f.eks. navigering mellom rutiner)
	useEffect(() => {
		setAction(hasSource ? "replace" : "new")
		setDeadlinePolicy("continue")
	}, [hasSource])
