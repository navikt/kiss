...
/* sql */ `INSERT INTO routine_reviews (routine_id, application_id, title, reviewed_at, status, created_by, updated_by) 
VALUES ('${routineId}', '${applicationId}', 'Test Review', '${reviewedAt.toISOString()}', 'completed', 'test-user', 'test-user') 
RETURNING id`,
)
