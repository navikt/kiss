...
/** Viser gruppering av team-badges etter tilgangsnivå. Brukere i mange team
 * (som eirikmol med push + 4× pull + maintain) vises kompakt med en badge per nivå. */
export const MangeBrukereOgTeam: Story = {
	name: "Mange brukere og team (grupperte badges)",
...
/** Én bruker via ett team – enkelt tilfellet. */
