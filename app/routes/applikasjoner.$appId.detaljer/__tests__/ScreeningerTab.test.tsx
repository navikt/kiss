...
describe("ScreeningerTab", () => {
	it("renders without crashing when screeningSessions is empty", () => {
		renderWithRouter(<ScreeningerTab screeningSessions={[]} appBasePath="/applikasjoner/app-1" />)
	...
	it("renders without crashing when screeningSessions is undefined", () => {
		...
		renderWithRouter(
			<ScreeningerTab screeningSessions={undefined as unknown as []} appBasePath="/applikasjoner/app-1" />,
		)
	...
	it("renders draft and completed sessions", () => {
		...
		renderWithRouter(<ScreeningerTab screeningSessions={sessions} appBasePath="/applikasjoner/app-1" />)
