...
export function mockTeamEditData() {
	return {
		...
		userCanAssignElevatedRoles: false,
	}
}
...
export function mockTeamRutinerData() {
	...
	const sectionRoutines = [
		{
			...mockDeadline({
				routineId: "sr-1",
				routineName: "Halvårlig ROS-analyse",
				applicationId: "app-1",
				applicationName: "pensjon-sak",
				priority: 1,
				frequency: "semi_annually",
		...
		},
		{
			...
			routine: {
				...
				createdAt: "2024-01-01T00:00:00.000Z",
				isSectionRoutine: 1 as 0 | 1,
				sectionRoutineOwnerRole: "Personvernombud",
				controls: [],
				technologyElementIds: [],
				technologyElements: [],
			},
